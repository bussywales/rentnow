...
export default function OnboardingRoleClient() {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-slate-600">This sets your account role. If you need to change it later, contact support.</p>
      </div>
      {!hasSession && (
        <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
          ...
          <p className="mt-1">
            ...
            click &quot;Refresh session&quot; to finish account setup.
          </p>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <Button variant="ghost" onClick={() => router.replace("/")} disabled={loading}>
          Back to home
        </Button>
