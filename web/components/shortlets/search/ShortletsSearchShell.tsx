...
function normalizeSearchItemImageFields(item: SearchItem): SearchItem {
  ...
  const thumbImageUrl = item.thumbImageUrl ?? item.mapPreviewImageUrl ?? primaryImageUrl;
  const cardImageUrl = item.cardImageUrl ?? primaryImageUrl;
  const heroImageUrl = item.heroImageUrl ?? cardImageUrl ?? primaryImageUrl;
  const mapPreviewImageUrl = item.mapPreviewImageUrl ?? thumbImageUrl ?? primaryImageUrl;
        ...
        return results.mapItems
          ...
          .map((item) => ({
            ...
            mapPreviewImageUrl:
              ...
              filteredById.get(item.id)?.thumbImageUrl ??
