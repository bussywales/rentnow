        ...
        <div className="scrollbar-none flex snap-x snap-mandatory gap-2.5 overflow-x-auto px-4 pb-1 pr-4 scroll-px-4">
          {featuredItems.map((item, index) => (
            <Link
              ...
              className={`relative inline-flex w-[235px] shrink-0 snap-start snap-always flex-col justify-between overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br p-3.5 text-white shadow-sm ${ACCENT_CLASSES[index % ACCENT_CLASSES.length]}`}
            >
