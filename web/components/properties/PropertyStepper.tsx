...
const listingTypes: { label: string; value: ListingType }[] = [
  ...
  { label: "Student (Rooms)", value: "student" },
  { label: "Hostel (Beds)", value: "hostel" },
                  ...
                  <label className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      <span className="block text-xs text-slate-600">
                        Demo listings are labelled and excluded from customer-facing promotions.
                        Admins control whether badges and watermarks are shown.
                      </span>
                    </span>
                  </label>
                </div>
