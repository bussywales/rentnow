...
void test("queue select matches expected normalized contract", () => {
  const expected =
    "id,status,updated_at,submitted_at,is_approved,approved_at,rejected_at,is_active,owner_id,title,city,state_region,country_code,admin_area_1,admin_area_2,postal_code,latitude,longitude,location_label,location_place_id,created_at,rejection_reason,photo_count,has_cover,cover_image_url,has_video,video_count,price,currency,rent_period,rental_type,listing_type,bedrooms,bathrooms";
