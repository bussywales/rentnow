...
export async function searchProperties(
  ...
  const runQuery = async (
    ...
    const imageFields = includePosition
      ? "id,image_url,position,created_at,width,height,bytes,format,blurhash,storage_path,original_storage_path,thumb_storage_path,card_storage_path,hero_storage_path"
