...
export const DELIVERY_MONITOR_SEED_ITEMS: DeliveryMonitorSeedItem[] = [
  ...
  },
  {
    ...
    testingGuide: [
      ...
      "Run the Canada entitlement-consume contract tests and confirm valid granted entitlements build listing-only consume payloads while mutation stays DISABLED.",
