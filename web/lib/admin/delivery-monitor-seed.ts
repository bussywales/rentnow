...
export const DELIVERY_MONITOR_SEED_ITEMS: DeliveryMonitorSeedItem[] = [
  ...
  },
  {
    ...
    nextAction: "Validate the Canada Stripe prep layer and disabled checkout creation path before shipping any live Stripe session integration.",
    description:
    ...
    outstanding: [
      ...
      "Canada PAYG checkout session creation remains intentionally disabled until live Stripe session integration ships on top of the guarded runtime wiring.",
      "Webhook/callback recovery for Canada one-off Stripe payments is still not implemented.",
