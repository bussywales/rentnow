...
- `/admin` is the overview cockpit; all approvals happen in `/admin/review`. If the review desk fails to load, use the diagnostics link or open `/admin/review` in a new tab.
