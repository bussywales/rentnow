...
1. Open `/host` and complete listing essentials.
...
<Callout type="info">
Featured requests and pricing are workflow controls, not automatic guarantees. Quality still drives conversion.
</Callout>
